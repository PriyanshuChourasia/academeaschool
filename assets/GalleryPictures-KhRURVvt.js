import{u as o,j as s}from"./index-oq_3IXbN.js";import{G as i}from"./GalleryGithubData-lLpzQgno.js";const a=()=>{let{imageId:l}=o();return s.jsx(s.Fragment,{children:s.jsxs("div",{className:"py-16",children:[s.jsx("div",{className:"pb-16",children:s.jsx("h1",{className:"text-center font-semibold underline underline-offset-2 text-6xl",children:i.filter(e=>e.id==l).map(e=>e.name)})}),s.jsx("div",{className:`flex justify-center  gap-10 flex-wrap  overflow-hidden mobile-xs:flex mobile-xs:flex-col
