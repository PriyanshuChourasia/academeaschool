...
const AboutMessage = () => {
    return (
        <div className='my-12 overflow-hidden'>
            <div className="grid px-20 mobile-xs:grid-rows-2 mobile-sm:grid-rows-2 mobile-md:grid-rows-2 desktop-xs:grid-cols-2 desktop-sm:grid-cols-2 desktop-md:grid-cols-2 desktop-lg:grid-cols-2 desktop-xl:grid-cols-2 mobile-xs:px-4 mobile-sm:px-10 mobile-md:px-14 ">
                <div className={`${AboutCss.principalBg}`}>

                </div>
                <div className='py-24 mobile-xs:py-8 mobile-sm:px-1 mobile-sm:py-10 mobile-md:px-2 bg-light-darkPrimary'>
            ...
            <div className="grid px-20 mobile-xs:mt-2 mobile-sm:mt-2 mobile-md:mt-2 mobile-xs:grid-rows-2 mobile-sm:grid-rows-2 mobile-md:grid-rows-2 desktop-xs:grid-cols-2 desktop-sm:grid-cols-2 desktop-md:grid-cols-2 desktop-lg:grid-cols-2 desktop-xl:grid-cols-2 desktop-2xl:grid-cols-2 mobile-xs:px-4 mobile-sm:px-10 mobile-md:px-14">
